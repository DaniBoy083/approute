...
// Agora ela fica em app/(site)/dashboard/cadastro/page.tsx, mas a URL continua identica.
...
export default function Cadastro() {
  return (
    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 px-6 py-10 font-sans dark:bg-black">
      ...
      {/* Descricao da rota e da composicao de layouts. */}
      <p className="mt-3 text-gray-600 dark:text-gray-400">
        Rota /dashboard/cadastro — utiliza o layout de dashboard e o grupo (site).
      </p>

      {/* Card explicando a localizacao real do arquivo no projeto. */}
      <div className="mt-6 w-full max-w-2xl rounded-xl border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900 dark:border-amber-900 dark:bg-amber-950/30 dark:text-amber-200">
        Este arquivo foi movido para <strong>app/(site)/dashboard/cadastro</strong>, mas o usuario continua acessando a URL <strong>/dashboard/cadastro</strong>.
      </div>
